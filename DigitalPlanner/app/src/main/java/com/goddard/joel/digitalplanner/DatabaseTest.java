...
public class DatabaseTest {
    ...
    public static void test(Context context){
        ...
        long idLesson3a = DatabaseTableLesson.insert(db, idBlockA3, Calendar.getInstance().getTime(), false);
        long idLesson4a = DatabaseTableLesson.insert(db, idBlockA4, Calendar.getInstance().getTime(), false);
        long idLesson5a = DatabaseTableLesson.insert(db, idBlockA5, Calendar.getInstance().getTime(), false);
        long idLesson6a = DatabaseTableLesson.insert(db, idBlockB1, Calendar.getInstance().getTime(), false);
        long idLesson7a = DatabaseTableLesson.insert(db, idBlockB2, Calendar.getInstance().getTime(), false);
        long idLesson8a = DatabaseTableLesson.insert(db, idBlockB3, Calendar.getInstance().getTime(), false);
        long idLesson1b = DatabaseTableLesson.insert(db, idBlockA1, Calendar.getInstance().getTime(), false);
        long idLesson2b = DatabaseTableLesson.insert(db, idBlockA2, Calendar.getInstance().getTime(), false);
        long idLesson3b = DatabaseTableLesson.insert(db, idBlockA3, Calendar.getInstance().getTime(), false);
        long idLesson4b = DatabaseTableLesson.insert(db, idBlockA4, Calendar.getInstance().getTime(), false);
        long idLesson5b = DatabaseTableLesson.insert(db, idBlockA5, Calendar.getInstance().getTime(), false);
        long idLesson6b = DatabaseTableLesson.insert(db, idBlockB1, Calendar.getInstance().getTime(), false);
        long idLesson7b = DatabaseTableLesson.insert(db, idBlockB2, Calendar.getInstance().getTime(), false);
        long idLesson8b = DatabaseTableLesson.insert(db, idBlockB3, Calendar.getInstance().getTime(), false);
        long idLesson1c = DatabaseTableLesson.insert(db, idBlockB4, Calendar.getInstance().getTime(), false);
        long idLesson2c = DatabaseTableLesson.insert(db, idBlockB4, Calendar.getInstance().getTime(), false);
        long idLesson3c = DatabaseTableLesson.insert(db, idBlockB5, Calendar.getInstance().getTime(), false);
        long idLesson4c = DatabaseTableLesson.insert(db, idBlockA1, Calendar.getInstance().getTime(), false);
        long idLesson5c = DatabaseTableLesson.insert(db, idBlockA2, Calendar.getInstance().getTime(), false);

        long idHomework1 = DatabaseTableHomework.insert(db, idLesson1a, idLesson1b, 60, Calendar.getInstance().getTime(), "Do the homework 1", "h1");
        long idHomework2 = DatabaseTableHomework.insert(db, idLesson2a, idLesson6a, 60, Calendar.getInstance().getTime(), "Do the homework 2", "h2");
        long idHomework3 = DatabaseTableHomework.insert(db, idLesson2a, idLesson4b, 120, Calendar.getInstance().getTime(), "Do the homework 3", "h3");
        long idHomework4 = DatabaseTableHomework.insert(db, idLesson3a, idLesson5b, 60, Calendar.getInstance().getTime(), "Do the homework 4", "h4");
        long idHomework5 = DatabaseTableHomework.insert(db, idLesson1b, idLesson2c, 60, Calendar.getInstance().getTime(), "Do the homework 5", "h5");
        long idHomework6 = DatabaseTableHomework.insert(db, idLesson3a, idLesson3c, 60, Calendar.getInstance().getTime(), "Do the homework 6", "h6");
